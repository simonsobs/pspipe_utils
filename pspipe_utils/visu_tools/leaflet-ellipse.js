...
L.Ellipse = L.Path.extend({
    ...
    //// This hardcodes Earth mercator
    //_getLatRadius: function () { return (this._mRadiusY / 40075017) * 360; },
    //_getLngRadius: function () { return ((this._mRadiusX / 40075017) * 360) / Math.cos((Math.PI / 180) * this._latlng.lat); },

    // This hardcodes CAR
    _getLatRadius: function () { return this._mRadiusY; },
    _getLngRadius: function () { return this._mRadiusX / Math.cos((Math.PI / 180) * this._latlng.lat); },
