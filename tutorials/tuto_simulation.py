...
import numpy as np
import pylab as plt
from pspipe_utils import simulation, pspipe_list, misc, best_fits
...
l, fg_mat = simulation.foreground_matrix_from_files(f_name_fg, array_list, lmax_sim, spectra)
noise_mat = {}
for sv in surveys:
...
for iii in range(n_sims):
    ...
    fglms = simulation.generate_fg_alms(fg_mat, array_list, lmax_sim)
    sim_alm = {}
